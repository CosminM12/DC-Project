// 8-bit logical right barrel shifter — 3 mux stages (shift by 1, 2, 4).
...
module barrel_shifter_right(
    ...
    mux2to1 s0_b3(.A(A[3]), .B(A[4]),  .sel(shift_amt[0]), .out(s0[3]));
    mux2to1 s0_b4(.A(A[4]), .B(A[5]),  .sel(shift_amt[0]), .out(s0[4]));
    mux2to1 s0_b5(.A(A[5]), .B(A[6]),  .sel(shift_amt[0]), .out(s0[5]));
    ...
    mux2to1 s1_b3(.A(s0[3]), .B(s0[5]), .sel(shift_amt[1]), .out(s1[3]));
    mux2to1 s1_b4(.A(s0[4]), .B(s0[6]), .sel(shift_amt[1]), .out(s1[4]));
    mux2to1 s1_b5(.A(s0[5]), .B(s0[7]), .sel(shift_amt[1]), .out(s1[5]));
    ...
    mux2to1 s2_b3(.A(s1[3]), .B(s1[7]), .sel(shift_amt[2]), .out(C[3]));
    mux2to1 s2_b4(.A(s1[4]), .B(1'b0),  .sel(shift_amt[2]), .out(C[4]));
